...
ARG host_uid=1001
ARG host_gid=1001
RUN groupadd -g $host_gid cuteradio && useradd -g $host_gid -m -s /bin/bash -u $host_uid cuteradio
...
ENV BUILD_INPUT_DIR /home/cuteradio/yocto/input
ENV BUILD_OUTPUT_DIR /home/cuteradio/yocto/output
...
RUN git clone --recurse-submodules https://github.com/bstubert/cuteradio.git
...
ENV TEMPLATECONF=$BUILD_INPUT_DIR/cuteradio/sources/meta-cuteradio/custom
CMD source $BUILD_INPUT_DIR/cuteradio/sources/poky/oe-init-build-env build \
